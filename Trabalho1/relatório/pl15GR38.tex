...
\title{Processamento de Linguagens  (3º ano de MIEI)\\ \textbf{Trabalho Prático 1}\\ \textit{Normalizador de ficheiros BibTex} }
...
Nesta alínea é construido um grafo que mostra para um dado autor escolhido pelo utilizador os autores com quem ele normalmente publica. O resultado da aplicação do algoritmo foi colocado num ficheiro \textit{.dot} e executámos o seguinte comando para gerar um ficheiro de imagem: 
...
\end{verbatim}
 ...
 Mostrámos de seguida um exemplo de um grafo. 
