...
Nesta alínea  temos a geração de um grafo com o nome do autor inserido pelo utilizador. Obtivemos o resultado de todos os autores que publicam normalmente com o autor \textbf{JosJooAlmeida}. 

\begin{figure}[<+htpb+>]
	\centering
	\includegraphics[scale=0.7]{grafoutput}
	\caption{Exemplo de geração de um grafo com os nomes dos autores com recurso à ferramenta \textit{Graph Viz} }
	\label{p1:fig:graph}
\end{figure}
