...
Implementou-se um filtro que permite fazer a contagem das categorias das referências bibliográficas, também foi implementado um filtro que permitirá a troca para chavetas do campo que está entre aspas e ainda os nomes dos autores  escritos no formato "N. Apelido". De modo a tornar a leitura mais fácil será feita um ferramenta de \textit{pretty-printing}
