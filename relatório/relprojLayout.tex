...
Utilizamos arrays  
strtoken para apanhar o que está entre chavetas ou aspas 
strstr para cortar a string por autores 
...
Este filtro tal como o anterior serve para apanhar o conteúdo do campo \textbf{author = } para os dois casos possiveis no ficheiro \textit{.bf}. 
\begin{verbatim}
"author ="[ ]*"\""  {BEGIN (AUT);} 
"author ="[ ]*"\{"  {BEGIN (AUT);} 
\end{verbatim}
