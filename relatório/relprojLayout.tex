...
\subsection{Alinea a)}
Nesta alinea optou-se por utilizar listas ligadas porque o nosso objetivo é armazenar as categorias das referências do \textit{BibTex}
...
Lista-se a seguir o código \textit{flex} que foi desenvolvido: 
